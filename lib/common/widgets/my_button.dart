            ...
            (states) {
              if (states.contains(MaterialState.disabled)) {
                return disabledTextColor ??
                    (isDark
                        ? AppColors.dark_text_disabled
                        : AppColors.text_disabled);
              }
              return textColor ??
                  (isDark ? AppColors.dark_button_text : Colors.white);
            },
          ),
          // 背景颜色
          backgroundColor: MaterialStateProperty.resolveWith((states) {
            if (states.contains(MaterialState.disabled)) {
              return disabledBackgroundColor ??
                  (isDark
                      ? AppColors.dark_button_disabled
                      : AppColors.button_disabled);
            }
            return backgroundColor ??
                (isDark ? AppColors.dark_app_main : AppColors.app_main);
          }),
          // 水波纹
